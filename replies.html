    ...
    <div class="main-wrapper">
      ...
      <div class="search-content">
        ...
        <div class="search-content-header">
          ...
          <h6>></h6>
          <!-- Dynamic -->
          <h6>Pourquoi le calcul ne fonctionne pas ?</h6>
        </div>
      </div>
      <!-- Root Post -->
              ...
              <div class="post-right">
                ...
                <div class="post-right-body post-right-body-replies">
                  <p>
                    ...
                    récapitulative. Auriez-vous une idée de ce que j’ai oublié
                    de faire ? Voici la formule : Voici ce que je demande en
                    slide 10 : Voici l’aperçu de la slide récapitulative :
                  </p>
                </div>
              </div>
            </div>
      ...
      <!-- Reply Input -->
      <div class="reply-container posts-wrapper-replies">
        <h1>Reply</h1>
        <textarea
          id="description"
          name="description"
